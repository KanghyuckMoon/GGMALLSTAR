...
public class Agent_Behaviour : BehaviourTree
{
	private CharacterSkill_Agent characterSkill_Agent;
	private CharacterSkill_Agent CharacterAIInput_Agent
	{
		get
		{
			characterSkill_Agent ??= mainCharacter.GetCharacterComponent<CharacterSkill_Agent>(ComponentType.Skill1);
			return characterSkill_Agent;
		}
	}
	...
	{
		return CharacterAIInput_Agent.IsCanUseSkill1;
	}
	protected bool Skill2Condition()
	{
		return CharacterAIInput_Agent.IsCanUseSkill2;
	}
	protected bool AllStarSkillCondition()
	{
		return CharacterAIInput_Agent.IsCanUseSkill3;
	}
